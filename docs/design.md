...
（造轮子是不可能的，这辈子是不可能造轮子的！虽然是一款新的播放器，但是各项功能可以采用社区已有实现，只是在核心的设计上多花功夫即可）
...
## 设计目标
 ...
 功能灵活拆解与扩展，使用者可以按需取用，渐进增强

## 设计思路及折衷

### 设计思路

将非必需的功能全部剥离出去，作为插件提供

larkplayer 本身只是一个核心，为用户提供基本以及必不可少的功能

各个功能的解耦有利于维护和扩展，不过对于使用者而言，可能需要多引一些文件
